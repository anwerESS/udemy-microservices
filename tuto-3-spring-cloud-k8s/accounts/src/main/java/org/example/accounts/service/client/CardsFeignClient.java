...
@FeignClient(name = "cards", url ="http://cards:9000", fallback = CardsFallback.class) // Declares this interface as a Feign client for the "cards" service.
...
public interface CardsFeignClient {
    ...
    );  // Defines a method to call the remote API.
